...
export const About = () => {
  return (
    <section
      className="flex flex-col lg:flex-row items-center justify-center w-full py-8 gap-10 px-4"
      id="about"
    >
      <ScrollFadeIn delay={0.1}>
        ...
        <div className="relative after:top-[14px] hover:after:top-[24px] hover:after:left-[24px] transition-all duration-400 hover:-translate-x-2 hover:-translate-y-2 after:transition-all after:duration-400 after:left-[14px] after:w-full after:h-full after:border-2 after:border-primary after:rounded-lg after:-z-10 z-0">
          <Image
            alt="about"
