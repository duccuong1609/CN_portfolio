...
export const metadata: Metadata = {
    ...
    description: "A deep dive into MEM Movies, a next-generation cinematic streaming platform built for high-fidelity visuals and real-time social interaction.",
    openGraph: {
